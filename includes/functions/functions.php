...
/** ################################# functions belongs to front end ################################# */
...
function getAllFrom($field, $table, $orderField, $where=null, $and = null, $ordering="DESC"){
    ...
    /* check user status 
    *  بتاعته = 0 فده كده معناها اني محتاج افعله RegStatusلو رجعت 1 معناها انها لقيت الشخص اللي بدور عليه ال 
    * لكن لو رجعت 0 فده معناه انه مفعل خلاص يعني الرج استيتيس بتساوي 1 اصلا 
    */
